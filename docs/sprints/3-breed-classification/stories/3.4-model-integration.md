...
- [ ] BreedModel class implemented
- [ ] Breed labels mapping loaded correctly
...
- [ ] Create BreedModel class
- [ ] Load breed labels from JSON
- [ ] Implement prediction with Top-5 output
- [ ] Write unit tests
- [ ] Add docstrings
