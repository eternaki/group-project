...
- [x] BBoxModel class implemented in packages/models/bbox.py
- [x] Model weights stored in standard location
...
- [x] Create BBoxModel class following base interface
- [x] Implement load(), preprocess(), predict(), postprocess()
- [x] Add configuration dataclass
- [x] Copy best weights to models/ directory
- [x] Write unit tests
