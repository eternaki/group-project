...
- [ ] YOLOv8m base model loaded with pretrained weights
...
- [ ] Set up training environment with GPU
- [ ] Create training script (scripts/training/train_bbox.py)
- [ ] Configure hyperparameters
- [ ] Run training
- [ ] Monitor training with TensorBoard/W&B
- [ ] Select best checkpoint based on val mAP
