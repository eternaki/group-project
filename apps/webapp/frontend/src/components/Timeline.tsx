/**
 * Komponent Timeline — wizualna reprezentacja klatek neutralnych i szczytowych.
 */
...
export default function Timeline() {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mt-6">
      <h2 className="text-xl font-bold mb-4">Oś czasu</h2>
      ...
      <div className="relative w-full h-16 bg-gray-200 rounded-lg overflow-visible">
        ...
        <div
          ...
          title={`Klatka neutralna: ${neutral_frame_idx}`}
        >
        ...
        {peak_frames.map((peak, idx) => (
          <div
            ...
            title={`Szczyt ${idx + 1}: Klatka ${peak.frame_idx} - ${peak.emotion}`}
          >
      ...
      <div className="flex gap-6 mt-8 text-sm">
        <span className="flex items-center gap-2">
          ...
          Klatka neutralna ({neutral_frame_idx})
        </span>
        <span className="flex items-center gap-2">
          <div className="w-3 h-3 bg-red-500 rounded"></div>
          Klatki szczytowe ({peak_frames.length})
        </span>
      </div>
